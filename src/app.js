...
const plans = [
  {
    ...
    limits: "Up to 300 customers in the first month",
    includes: ["Customer list", "Review request tracking", "CSV data backup", "Editable templates", "50 automated review requests", "20 follow-up tasks"]
  },
  {
    id: "starter",
    name: "Starter",
